...
export default class BestAuthor extends Component {
  constructor(props) {
    super(props);
  }
          ...
          <div class="row">
            <div class="col-lg-4 col-wd-3 d-flex">
              <img
                ...
                src={require("../../assets/img/400x759/img1.png")}
                alt="Image-Description"
              />
            </div>
            <div class="col-lg-8 col-wd-9">
              <div class="mb-8">
                <span class="text-gray-400 font-size-2">
                  AUTHOR OF THE MONTH
                </span>
                  ...
                  <div class="product__inner overflow-hidden p-3 p-md-4d875 mx-1 bg-white">
                    <div class="woocommerce-LoopProduct-link woocommerce-loop-product__link d-block position-relative">
                      <div class="woocommerce-loop-product__thumbnail">
                        <a
                          href="../shop/single-product-v7.html"
                          class="d-block"
                        >
                          <img
                            src={require("../../assets/img/120x180/img1.jpg")}
                      ...
                      <div class="woocommerce-loop-product__body product__body pt-3 bg-white">
                        <div class="text-uppercase font-size-1 mb-1 text-truncate">
                          <a href="../shop/single-product-v7.html">Paperback</a>
                        </div>
                        <h2 class="woocommerce-loop-product__title product__title h6 text-lh-md mb-1 text-height-2 crop-text-2 h-dark">
                          <a href="../shop/single-product-v7.html">
                      ...
                      <div class="product__hover d-flex align-items-center">
                        <a
                          href="../shop/single-product-7.html"
                        ...
                        <a
                          href="../shop/single-product-7.html"
                          class="mr-1 h-p-bg border-0 btn-outline-primary"
                          tabindex="0"
                        >
                        ...
                        <a
                          href="../shop/single-product-7.html"
                          class="h-p-bg border-0 btn-outline-primary"
                          tabindex="0"
                        >
                  ...
                  <div class="product__inner overflow-hidden p-3 p-md-4d875 mx-1 bg-white">
                    <div class="woocommerce-LoopProduct-link woocommerce-loop-product__link d-block position-relative">
                      <div class="woocommerce-loop-product__thumbnail">
                        ...
                        >
                          <img
                            src={require("../../assets/img/120x180/img2.jpg")}
                            class="img-fluid d-block mx-auto attachment-shop_catalog size-shop_catalog wp-post-image"
                            alt="image-description"
                          />
                        </a>
                  ...
                  <div class="product__inner overflow-hidden p-3 p-md-4d875 mx-1 bg-white">
                    <div class="woocommerce-LoopProduct-link woocommerce-loop-product__link d-block position-relative">
                      <div class="woocommerce-loop-product__thumbnail">
                        ...
                        >
                          <img
                            src={require("../../assets/img/120x180/img3.jpg")}
                            class="img-fluid d-block mx-auto attachment-shop_catalog size-shop_catalog wp-post-image"
                            alt="image-description"
                          />
                        </a>
                  ...
                  <div class="product__inner overflow-hidden p-3 p-md-4d875 mx-1 bg-white">
                    <div class="woocommerce-LoopProduct-link woocommerce-loop-product__link d-block position-relative">
                      <div class="woocommerce-loop-product__thumbnail">
                        ...
                        >
                          <img
                            src={require("../../assets/img/120x180/img4.jpg")}
                            class="img-fluid d-block mx-auto attachment-shop_catalog size-shop_catalog wp-post-image"
                            alt="image-description"
                          />
                        </a>
